"""Contenido normativo de referencia (cliente: Oldelval).
Se mantiene el contenido tal cual — solo se despegó la identidad visual (logos/colores)
del código; este módulo queda como el lugar natural para, en el futuro, intercambiar
el contenido por el de otro cliente sin tocar la lógica de las pantallas."""
...
TIPIFICACION_SUELOS_URL = "https://isotools.oldelval.local/procedimientos/tipificacion-de-suelos"
